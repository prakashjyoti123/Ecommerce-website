...
const Connection = async (username, password) => {
  ...
  const URL = `mongodb://${username}:${password}@ecomr-shard-00-00.r9kuq.mongodb.net:27017,ecomr-shard-00-01.r9kuq.mongodb.net:27017,ecomr-shard-00-02.r9kuq.mongodb.net:27017/?ssl=true&replicaSet=atlas-8yp6v6-shard-0&authSource=admin&retryWrites=true&w=majority`;
  try {
